...
export const tr = {
  ...
  haberlerAdmin: {
    title: "Haberler",
    subtitle:
      "Blog / yazı / video yapısı. Flexlore bağlanana kadar draft kaydet veya JSON export et; yayına content dosyasına eklenir.",
  ...
  analytics: {
    ...
    gaApiHint:
      "Canlı Google raporları için Hostinger env: GA4_PROPERTY_ID, GA4_CLIENT_EMAIL, GA4_PRIVATE_KEY",
...
export const en: Messages = {
  ...
  haberlerAdmin: {
    title: "News",
    subtitle:
      "Blog / article / video structure. Until Flexlore connects: save drafts or export JSON into the content file.",
  ...
  analytics: {
    ...
    gaApiHint:
      "For live Google reports set env: GA4_PROPERTY_ID, GA4_CLIENT_EMAIL, GA4_PRIVATE_KEY",
    openGoogle: "Google Analytics",
    range7: "7 days",
    range28: "28 days",
    range90: "90 days",
