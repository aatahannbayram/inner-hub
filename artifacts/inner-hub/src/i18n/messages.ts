...
export const tr = {
  ...
  invite: {
    ...
    successBody:
      "Her talebi dikkatle inceliyoruz. Otomatik yanıt yok. Önemli olduğunda gerçek bir cevap.",
...
export const en: Messages = {
  ...
  invite: {
    ...
    successBody:
      "We review every request carefully. No automated replies. Only a real answer when it matters.",
