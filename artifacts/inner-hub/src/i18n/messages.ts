...
export const tr = {
  ...
  sss: {
    ...
    metaDescription:
      "inner.hub nedir, davetiye nasıl alınır? inner.digital, innerdigital.com IT şirketinden bağımsız bir davetli kurucu ağıdır.",
  ...
  home: {
    ...
    heroBody:
      "Davetli bir üyelik. Kurucular, mühendisler ve yatırımcılar için. Statü için değil; doğru insanlarla erken buluşmak için.",
    requestInvitation: "Davetiye iste",
    ...
    ideaReveal:
      "İstanbul’da başlıyoruz. Üyeler tek tek seçilir. Platform abonesi değil; sonraki adımı mümkün kılan insanlar.",
    ...
    learnMore: "Devamı",
    seatsFooter:
      "Bu üyelik sıradan abonelik değil. inner·hub’ın davetli çekirdeği.",
    ...
    modPulseTag: "Yolda",
    modPulseDesc:
      "Ekosistem panosu. Çember içindeki hareketi takip eden sinyaller.",
    modIdTag: "Açık",
    modIdDesc:
    ...
    whatThisIsBody:
      "Fikirler burada konuşulur, denenir ve kurup fonlayabilecek insanlar tarafından desteklenir. Yüz yüze buluşmalar davetiye sürecinin içindedir.",
...
export const en: Messages = {
  ...
  sss: {
    ...
    metaDescription:
      "What is inner.hub, how do invitations work? inner.digital is an invite-only founder circle — not InnerDigital, the IT company.",
  ...
  home: {
    ...
    heroBody:
      "Invite-only membership for founders, builders, and investors. Bound by hunger to meet the right people early — not for status.",
    requestInvitation: "Request an invitation",
    ...
    ideaReveal:
      "It starts in İstanbul. Members are chosen one by one: not platform subscribers, but the people who make what comes next possible.",
    ...
    seatsFooter:
      "This is not ordinary membership. It is the invite-only core of inner.hub.",
    ...
    modPulseTag: "Roadmap",
    modPulseDesc:
      "Ecosystem pulse board. Live signals from inside the circle.",
    modIdTag: "Live",
    modIdDesc:
    ...
    whatThisIsBody:
      "New ideas are discussed, tested, and backed by people who can build and fund them. In-person gatherings stay inside the invitation flow.",
