...
/** Uzun SEO/AEO yazıları - Flexlore bağlanana kadar kaynak */
export const SEO_POSTS: Artifact[] = [
  {
    ...
    tr: {
      ...
      description:
        "Davetiye ile girilen kurucu-yatırımcı ağlarında deal flow neden daha hızlı ve kaliteli ilerler? inner.hub modeli, güven, uyum ve erken sinyal üzerine.",
      answer:
        "Kapalı çemberde deal flow hızlanır çünkü her bağlantı önceden filtrelenmiş güvene dayanır. Açık ağlarda gürültü artar; davetiye ile kurulan çemberde sinyal, sermaye ve kurucu aynı standartta buluşur.",
      body: [
    ...
    en: {
      ...
      description:
        "Why invitation-only founder-investor networks move deal flow faster and with higher signal - the inner.hub model of trust, fit, and early access.",
      answer:
  ...
  },
  {
    ...
    tr: {
      ...
      description:
        "inner.hub gathering’i bir konferans değildir. Kapalı oda, seçili katılımcı, iş üreten format - konferans ekonomisinden neden farklılaşır?",
      answer:
        "Gathering, konferans değildir: biletli sahne yerine davetiye ile girilen kapalı bir çalışma odasıdır. Amaç içerik tüketmek değil; sinyal, sermaye ve kurucuları aynı standartta buluşturmaktır.",
      body: [
    ...
    en: {
      ...
      description:
        "An inner.hub gathering is not a conference. Closed room, invited guests, work-first format - why it diverges from conference economics.",
      answer:
        "A gathering is not a conference: it is an invitation-only working room, not a ticketed stage. The goal is not content consumption - it is putting signal, capital, and founders on one standard.",
      body: [
  ...
  },
  {
    ...
    tr: {
      ...
      description:
        "AEO (Answer Engine Optimization) nedir, SEO’dan farkı nedir? inner.hub haberlerinde net cevap, FAQ şeması ve uzun form içerikle nasıl uygulanır?",
      answer:
        "AEO, içeriği arama motorlarından ziyade cevap motorları (ChatGPT, Perplexity, Google AI Overviews) için optimize etmektir. Net bir ilk cevap, yapılandırılmış FAQ ve kanıtlayan uzun gövde ile yapılır.",
      body: [
    ...
    en: {
      ...
      description:
        "What Answer Engine Optimization is, how it differs from SEO, and how inner.hub news uses clear answers, FAQ schema, and long-form proof.",
      answer:
        "AEO optimizes content for answer engines (ChatGPT, Perplexity, Google AI Overviews), not only classic search rankings. It starts with a clear first answer, structured FAQ, and a long body that proves the claim.",
      body: [
