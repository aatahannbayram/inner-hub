...
> **Durum 2026-07-25 (Cursor devam 3):** F1 tipografi: `text-[7–10px]` → `text-label` (~450), `text-[11px]` → `text-caption` (~33). Build CSS doğrulandı: `.text-label{font-size:.6875rem;line-height…;letter-spacing…}`. F3 success-ink, F5 tr.ts/lang=en, PanelNav prefetch önceki turda.
